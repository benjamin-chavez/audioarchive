...
module "codebuild_server" {
  ...
  container_name         = var.container_name["server"]
  client_url             = module.ssm_parameters.client_url_arn
  use_local_db_tunnel    = module.ssm_parameters.use_local_db_tunnel_arn
  ...
  auth0_audience         = module.ssm_parameters.auth0_audience_arn
  auth0_base_url         = module.ssm_parameters.auth0_base_url_arn
  auth0_client_id        = module.ssm_parameters.auth0_client_id_arn
  auth0_client_secret    = module.ssm_parameters.auth0_client_secret_arn
  auth0_issuer_base_url  = module.ssm_parameters.auth0_issuer_base_url_arn
  auth0_scope            = module.ssm_parameters.auth0_scope_arn
  auth0_secret           = module.ssm_parameters.auth0_secret_arn
  stripe_publishable_key = module.ssm_parameters.stripe_publishable_key_arn
  stripe_secret_key      = module.ssm_parameters.stripe_secret_key_arn
  stripe_webhook_secret  = module.ssm_parameters.stripe_webhook_secret_arn
  aws_mq_username        = module.ssm_parameters.aws_mq_username_arn
  aws_mq_password        = module.ssm_parameters.aws_mq_password_arn
  aws_mq_broker_url      = module.ssm_parameters.aws_mq_broker_url_arn
  aws_mq_port            = module.ssm_parameters.aws_mq_port_arn
...
module "codepipeline" {
  ...
  # github_token             = module.ssm_parameters.github_t_ken
...
module "psql_rds" {
  ...
  # db_name                = module.ssm_parameters.db__ame
  # password               = module.ssm_parameters.db_pass_ord
  db_name = "postgres"
  ...
  # db_user                = module.ssm_parameters.db__ser
