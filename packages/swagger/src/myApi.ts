...
export interface ExampleSchemaBody {
  /** @example "This is some example string! This is an endpoint" */
  responseText?: string;
}

export interface ExampleSchemaHeader {
...
export interface AppUser {
  ...
  avatarS3Key?: string;
  /**
   * S3 URL for the user's avatar image
   * @format uri
   */
  avatarS3Url?: string;
...
/**
 * @title Audio Archive API
 * @version 1.0.0
 * @baseUrl http://localhost:5000/api
 *
 * Audio Archive REST API
 */
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  api = {
    /**
     * @description Returns the health status of the API with environment info.
     *
     * @name HealthList
     ...
     * @request GET:/api/app-users
     */
    appUsersList: (params: RequestParams = {}) =>
      this.request<AppUser[], any>({
        path: `/api/app-users`,
        method: "GET",
        format: "json",
        ...params,
