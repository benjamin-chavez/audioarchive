...
export default function Products(fetchedProducts?: any) {
  ...
  // const loadPagesToReachScrollPosition = async (savedScrollPosition) => {
  //   while (window.scrollY < savedScrollPosition && hasNextPage) {
  //     await fetchNextPage();
  //   }
  // };

  // useEffect(() => {
  //   // Get the saved scroll position from the URL
  //   const params = new URLSearchParams(searchParams);
  //   const savedScrollPosition = searchParams.get('scroll');

  //   if (savedScrollPosition) {
  //     loadPagesToReachScrollPosition(parseInt(savedScrollPosition));
  //   }
  // }, []);
